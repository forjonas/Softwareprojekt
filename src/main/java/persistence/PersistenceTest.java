...
public class PersistenceTest {
    ...
    public static void createTestData() {
        ...
        Aufgabensammlung sammlung1 = new Testat(aufgabenListe, "Sehr Gut", "Hallo1234");
        Aufgabensammlung sammlung2 = new Training(aufgabenListe, 60, "Programmieren", 3, Aufgabentyp.EINFACHANTWORTAUFGABE);
