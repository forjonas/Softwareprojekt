...
public class EinfachantwortAufgabe extends Aufgabe {
     ...
     */
    public EinfachantwortAufgabe(int bearbeitungszeit, String javaDesign, String umlDesign, String kategorie, String loesungshinweis, int punktewert, int schwierigkeitsgrad, String textbeschreibung, String musterloesung, String userloesung) {
